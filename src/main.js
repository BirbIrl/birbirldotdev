...
function spawnFeather() {
	...
	var point = parsePointJson(getFeatherData(), ctx, new Vec(x, 0), featherScale, Math.random() * 360, pointSize, defaultLineWidth, "#FFFFFF", Math.random() / 3 + 0.5)
